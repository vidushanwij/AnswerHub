                ...
                <div class="form-content">
                    ...
                    <div class="website-logo-inside" style="text-align: center;">
                        ...
                        <div class="page-links">
                            <a href="login.php">Student Login</a><a href="#" class="active">Employer Login</a>
                        </div>
                        <form action="check_emp_login.php" method="POST">
                        ...
                        <div class="other-links">
                            <span>New User?</span><a href="employer_register.php">Create New Account</a>
                        </div>
                    </div>
                </div>
            </div>
